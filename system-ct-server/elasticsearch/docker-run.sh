...
run() {
	name=$1
	sudo docker run -itd -p 9200:9200 -p 9600:9600 --name=${IMAGE_NAME}-${name} ${IMAGE_NAME}:${IMAGE_TAG} /bin/bash
}
...
# docker run -itd -p 9200:9200 -p 9600:9600 --name=ct-elasticsearch ct-elasticsearch:0.1 /bin/bash
